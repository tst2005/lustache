do --{{
local sources, priorities = {}, {};assert(not sources["lustache.scanner"],"module already exists")sources["lustache.scanner"]=([===[-- <pack lustache.scanner> --
...
assert(not sources["lustache.renderer"],"module already exists")sources["lustache.renderer"]=([===[-- <pack lustache.renderer> --
...
assert(not sources["lustache.context"],"module already exists")sources["lustache.context"]=([===[-- <pack lustache.context> --
